package io.shixinyangyy.client.rsocket.server;

import io.shixinyangyy.client.rsocket.model.Message;
...
public class MessageRSocketController {
    ...
    /**
     * Shixinyangyy-MacBook-Pro:reactive-extension yuzhilin$ java -jar rsc.jar --debug --request --data "{\"origin\":\"Client\",\"interaction\":\"Request\"}" --route request-response tcp://localhost:8082
    ...
    /**
     * Shixinyangyy-MacBook-Pro:reactive-extension yuzhilin$ java -jar rsc.jar --debug --request --data "{\"origin\":\"Client\",\"interaction\":\"Request\"}" --route no-response tcp://localhost:8082
