...
import reactive.extension.client.rsocket.model.Message;
...
public class MessageRSocketController {
    ...
    /**
     * $ java -jar rsc.jar --debug --request --data "{\"origin\":\"Client\",\"interaction\":\"Request\"}" --route request-response tcp://localhost:8082
    ...
    /**
     * $ java -jar rsc.jar --debug --request --data "{\"origin\":\"Client\",\"interaction\":\"Request\"}" --route no-response tcp://localhost:8082
