...
package io.shixinyangyy.core.cache;
...
public class RedisOperationProperties {
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        Assert.isTrue(extendedRedis.enabled, () -> "redis cachePlugin enabled '" + extendedRedis.enabled + "' not initialized");
        Assert.hasText(extendedRedis.keyPrefix, () -> "redis cachePlugin keyPrefix '" + extendedRedis.keyPrefix + "' must not empty or null");
