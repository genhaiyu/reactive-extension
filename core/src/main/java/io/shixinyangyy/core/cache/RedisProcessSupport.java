...
public class RedisProcessSupport implements SmartInitializingSingleton {
    ...
    private void keyPrefix(final RedisOperationProperties redisOperationProperties, final String key) {
        ...
        assembleCacheKey = joiner.add(redisOperationProperties.getExtendedRedis().getKeyPrefix())
                .add(key).toString();
    }
    ...
    public boolean set(String key, Object value) {
        try {
            valueOps.set(getKeyPrefix(key), value, redisOperationProperties.getExtendedRedis().getExpire(), TimeUnit.SECONDS);
            return true;
        } catch (Exception e) {
