...
import io.shixinyangyy.boot.config.embedded.WebEmbeddedContainerMatcher;
 ...
 * @author Shixinyangyy
 */
@ConfigurationProperties("extension.jetty.shutdown")
public class GracefulShutdownJettyProperties implements InitializingBean {
    ...
    public void afterPropertiesSet() {
        WebEmbeddedContainerMatcher.embeddedContainerMatcher();
        LOG.info(toString());
    }
}
